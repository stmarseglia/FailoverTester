...
public class SDPRequestThread extends Thread {
	...
	public SDPRequestThread(CloseableHttpClient client, HttpGet get, LogManager log, MinMaxTimeoutIndentifier identifier) {
