...
public class BackEndDBRequestThread extends Thread {
	...
	public BackEndDBRequestThread(CloseableHttpClient client, HttpGet get, LogManager log, MinMaxTimeoutIndentifier identifier) {
