...
public class DRMRequestThread extends Thread {
	...
	public DRMRequestThread(CloseableHttpClient client, HttpGet get, LogManager log, MinMaxTimeoutIndentifier identifier) {
