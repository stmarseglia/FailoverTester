...
public class WebCacheRequestThread extends Thread {
	...
	public WebCacheRequestThread(CloseableHttpClient client, HttpGet get, LogManager log, MinMaxTimeoutIndentifier identifier) {
